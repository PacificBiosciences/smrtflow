...
-- GRANT SELECT, UPDATE, INSERT, DELETE ON ALL TABLES IN SCHEMA smrtlink_test TO smrtlink_test_user;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO smrtlink_test_user;
