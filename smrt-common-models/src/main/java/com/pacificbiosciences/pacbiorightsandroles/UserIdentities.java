 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://pacificbiosciences.com/PacBioRightsAndRoles.xsd}UserIdentity" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UserIdentities")
public class UserIdentities {

    @XmlElement(name = "UserIdentity", required = true)
    protected List<UserIdentityType> userIdentity;
     ...
     * 
     */
    public List<UserIdentityType> getUserIdentity() {
        if (userIdentity == null) {
            userIdentity = new ArrayList<UserIdentityType>();
        }
