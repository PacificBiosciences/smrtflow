...
| **Method** | **URI**                                                         |
+============+=================================================================+
| GET        | http://<host>:<port>/smrt-link/registry-service/resources       |
+------------+-----------------------------------------------------------------+
...
~~~~~~~~~~~~~~
| Get the list of all resources:
| GET http://smrtlink-alpha.nanofluidics.com:8081/smrt-link/registry-service/resources
...
+-------------------------------+-------------------------------------------------------------------------------+----------------+-----------------------------------+
| Date                          | The date and time that the message was sent.                                  | Yes            | Thu, 25 Feb 2016 01:35:47 GMT     |
+-------------------------------+-------------------------------------------------------------------------------+----------------+-----------------------------------+
| Content-Length                | The length of the response body in octets.                                    | Yes            | 2990                              |
+-------------------------------+-------------------------------------------------------------------------------+----------------+-----------------------------------+
...
+==================+========================================================+
| application/json | See `List all resources - response schema`_            |
+------------------+--------------------------------------------------------+

Sample Response
~~~~~~~~~~~~~~~
See `List all resources - response sample`_
...
.. _`List all resources - response schema`:

List all resources - response schema
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. literalinclude:: resources_list_schema.json
    :language: javascript

.. _`List all resources - response sample`:

List all resources - response sample
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. literalinclude:: list_all_resources_response_sample.json
    :language: javascript
