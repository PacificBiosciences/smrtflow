...
import com.pacbio.secondary.smrtlink.analysis.jobs.JobModels.{PipelineTemplatePreset, PipelineTemplate}
...
trait PipelineTemplateDaoComponent {
  ...
  def getPresetsFromPipelineTemplateId(pipelineTemplateId: String): Option[Seq[PipelineTemplatePreset]]

  def getPipelinePresetBy(pipelineTemplateId: String, presetId: String): Option[PipelineTemplatePreset]

}

class PipelineTemplateDao(pipelineTemplates: Seq[PipelineTemplate]) extends PipelineTemplateDaoComponent {
