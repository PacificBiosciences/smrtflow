...
class V1_9__CollectionPathUri extends JdbcMigration with SlickMigration {
  override def slickMigrate(db: DatabaseDef): Future[Any] = {
    db.run {
      for {
        newc <- V1_6Schema.collectionMetadata.result.map(_.map(o => (o._1, o._2, o._3, o._4, o._5, o._6, None, o._7, o._8, o._9, o._10, o._11, o._12, o._13)))
        _    <- V1_6Schema.collectionMetadata.schema.drop
...
object V9Schema extends PacBioDateTimeDatabaseFormat {
  ...
  class CollectionMetadataT(tag: Tag) extends Table[(UUID, UUID, String, String, Option[String], Option[String], Option[String], String, Option[String], Option[String], Double, Option[JodaDateTime], Option[JodaDateTime], Option[String])](tag, "COLLECTION_METADATA") {
    ...
    def run = foreignKey("RUN_FK", runId, V1_6Schema.runSummaries)(_.uniqueId)
