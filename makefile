...
test-int-get-data:
	scp -r login14-biofx01:/mnt/secondary/Share/smrtserver-testdata test-data-smrt-server

test-int-import-references:
	pbservice import-dataset --debug --port=8070 test-data-smrt-server/ds-references/

test-int-import-subreads:
	pbservice import-dataset --debug --port=8070 test-data-smrt-server/ds-subreads/
