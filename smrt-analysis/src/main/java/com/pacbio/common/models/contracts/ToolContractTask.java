...
public class ToolContractTask extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** This needs to be converted to an ENUM. Allowed values $tmpfile $tmpdir */
   ...
   * @param input_types The new value for input_types
   * @param output_types The new value for output_types
   * @param schema_options The new value for schema_options
   ...
   * @param resource_types This needs to be converted to an ENUM. Allowed values $tmpfile $tmpdir
   */
   ...
   * @return The value of the 'input_types' field.
   */
   ...
   * @return The value of the 'output_types' field.
   */
   ...
   * @return The value of the 'schema_options' field.
   */
   ...
   * @return This needs to be converted to an ENUM. Allowed values $tmpfile $tmpdir
   */
