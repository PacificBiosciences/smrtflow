...
import com.pacbio.secondary.analysis.pipelines.PipelineTemplateAvroLoader
 ...
 * @author mkocher
 */
class PipelineTemplateAvroSpec extends Specification with SecondaryJobJsonProtocol with LazyLogging{

  sequential

  "Test pipeline loading from Avro file" should {
    "Smoke test for pipeline" in {
      val name = "pipeline-templates-avro/pbsmrtpipe.pipelines.sa3_sat_pipeline_template.avro"
